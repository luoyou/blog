    ...
    <div :class="['home', slide]">
        ...
        <Gesture :swipeUp="() => changeSlide('up')" freezeTime="300" :eventInvoke="stopMove">
            <div class="wrapper wrapper-detail">
                <div class="avatar">
                    <img src="/sora.png" alt="雪非烟" draggable="false" />
                </div>
                <div class="card">
                    <div class="bio">
                        <div class="head">
                ...
                <div class="footer" v-if="data.footer">
                    ...
                    <!-- <a href="http://beian.miit.gov.cn/" target="_blank" rel="nofollow">备案号<span class="seg"> / </span></a> -->
        ...
        <Gesture :swipeDown="() => changeSlide('down')" freezeTime="300" :eventInvoke="stopMove">
            <div class="wrapper wrapper-brief">
                <div class="page-title-con">
                    <div class="page-title">Infinity</div>
